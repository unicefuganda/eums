...
from eums.models.question import Question, MultipleChoiceQuestion, NumericQuestion, TextQuestion
...
def seed_questions():
    ...
    TextQuestion.objects.get_or_create(
        uuids='abc9c005-7a7c-44f8-b946-e970a361b6cf', text='What date was it received?', label='dateOfReceipt')

    NumericQuestion.objects.get_or_create(
        uuids='6c1cf92d-59b8-4bd3-815b-783abd3dfad9', text='How much was received?', label='amountReceived')
    ...
    question_2, _ = MultipleChoiceQuestion.objects.get_or_create(
        ...
        text='Are you satisfied with the delivery?', label='satisfactionWithDelivery'
    )
