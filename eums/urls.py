...
from eums.api.delivery_stats.delivery_stats_endpoint import DeliveryStatsEndpoint
...
urlpatterns = patterns(
    ...
    url(r'^api/stock-report/(?P<consignee_id>\d+)/$', StockReport.as_view(), name='stock_report_for_consignee'),
