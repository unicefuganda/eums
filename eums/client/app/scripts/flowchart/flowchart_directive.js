...
//
    .directive('flowChart', function () {
        return {
            restrict: 'E',
            templateUrl: '/static/app/views/partials/flowchart_template.html',
            replace: true,
            scope: {
                chart: '=chart'
            },
...
//
    .directive('chartJsonEdit', function (flowchart) {
        return {
            restrict: 'A',
            scope: {
                viewModel: '='
...
//
    .controller('FlowChartController', ['$scope', 'dragging', '$element', function FlowChartController($scope, dragging, $element) {
        ...
        //
        $scope.connectorMouseDown = function (evt, node, connector, connectorIndex, isInputConnector, flowchart) {
