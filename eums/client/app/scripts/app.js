...
angular.module('eums', ['ngRoute', 'Home', 'Delivery', 'MultipleIpDirectDelivery', 'DirectDelivery', 'WarehouseDelivery',
    ...
    'DirectDeliveryIpChoice', 'Loader', 'IPResponses', 'ConsigneeItem', 'IpDeliveredItems', 'IpItemDeliveries', 'Alerts'])
...
.config(function ($routeProvider, $httpProvider) {
    ...
    $routeProvider
        ...
        .when('/consignee-delivery/:itemId', {
            templateUrl: '/static/app/views/delivery/ip-delivery/consignee-delivery.html',
            controller: 'ConsigneeDeliveryController',
            resolve: {
                permission: function (UserService) {
                    return UserService.checkUserPermission('auth.can_view_distribution_plans');
                }
