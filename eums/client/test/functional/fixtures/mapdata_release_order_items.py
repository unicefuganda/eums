...
ro_item_436 = ReleaseOrderItem.objects.create(purchase_order_item=po_item_429, release_order=ro_7, value=1799.80, item=item_174, item_number=10, quantity=10.00)
