...
MultipleChoiceAnswer.objects.create(run=run_7, question=eu_question_5, value=PRODUCT_WAS_RECEIVED)
MultipleChoiceAnswer.objects.create(run=run_9, question=WAS_PRODUCT_RECEIVED, value=eu_q5_option_no)
...
MultipleChoiceAnswer.objects.create(run=run_12, question=eu_question_5, value=PRODUCT_WAS_RECEIVED)
...
MultipleChoiceAnswer.objects.create(run=run_13, question=eu_question_5, value=PRODUCT_WAS_RECEIVED)
MultipleChoiceAnswer.objects.create(run=run_14, question=WAS_PRODUCT_RECEIVED, value=eu_q5_option_no)
MultipleChoiceAnswer.objects.create(run=run_14, question=eu_question_6, value=PRODUCT_WAS_RECEIVED)
...
MultipleChoiceAnswer.objects.create(run=run_15, question=eu_question_5, value=PRODUCT_WAS_RECEIVED)
...
MultipleChoiceAnswer.objects.create(run=run_17, question=WAS_PRODUCT_RECEIVED, value=eu_q5_option_no)
...
MultipleChoiceAnswer.objects.create(run=run_19, question=eu_question_5, value=PRODUCT_WAS_RECEIVED)
MultipleChoiceAnswer.objects.create(run=run_20, question=WAS_PRODUCT_RECEIVED, value=eu_q5_option_no)
MultipleChoiceAnswer.objects.create(run=run_20, question=eu_question_6, value=PRODUCT_WAS_RECEIVED)
