describe('IP Delivery Report Loss Controller', function () {
    var scope, routeParams, q, mockConsigneeItemService, mockDeliveryNodeService, ipNodes;
    ...
    beforeEach(function () {
        ...
        inject(function ($controller, $rootScope, $q) {
            ...
            mockDeliveryNodeService.reportLoss.and.returnValue($q.defer().promise);
    ...
    it('should call delivery node service and set nodes on scope', function () {
        ...
        expect(scope.deliveryGroups.count()).toBe(1);
    ...
    //it('should not save new delivery if all deliveries to IP have no or zero quantity selected', function () {
    //    scope.$apply();
    ...
    //});
    //
    //it('should fail to save new delivery if its quantities are from shipments with different order numbers but the same order type', function () {
    //    scope.$apply();
    //    setupNewDelivery();
    //    scope.selectedDeliveries = [
