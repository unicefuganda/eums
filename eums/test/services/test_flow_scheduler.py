...
class FlowSchedulerTest(TestCase):
    def xtest_should_schedule_a_flow_for_a_consignee_from_a_plan_node_with_one_line_item(self):
        fake_consignee = ConsigneeFactory.build()
        fake_consignee.contact = {'first_name': 'Test', 'last_name': 'User', 'phone': '+256 772 123456'}
        node = DistributionPlanNodeFactory.build(consignee=fake_consignee)
