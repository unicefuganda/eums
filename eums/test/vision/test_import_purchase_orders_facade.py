...
from eums.vision.vision_facade import PurchaseOrderFacade, ImportException


class TestPurchaseOrdersVisionFacade(TestCase):
    def setUp(self):
        self.purchase_order_file_location = 'purchase_orders.xlsx'
        self.purchase_order_with_missing_data_file_location = 'purchase_orders_with_missing_data.xlsx'
        self.create_purchase_order_workbook()
        self.create_purchase_order_workbook_with_missing_data()
        ...
        self.missing_data_facade = PurchaseOrderFacade(self.purchase_order_with_missing_data_file_location)

    def tearDown(self):
        os.remove(self.purchase_order_file_location)
        os.remove(self.purchase_order_with_missing_data_file_location)
    ...
    def create_purchase_order_workbook_with_missing_data(self):
        work_book = Workbook()
        sheet = work_book.add_sheet('Sheet 1')
        ...
        self.first_row = [u'1000', u'617', u'Kampala, Uganda', u'5617', u'', u'NB', u'0030323186', u'10', u'01/14/2015',
                          u'8000', u'SL005144', u'', u' ', u'', u'', u'ZLC',
                          u'01/15/2015', u'01/15/2015', u'SOLOWO', u'2300026922', u'1', u'', u'DAP', u'ALIVE:WASH',
                          u'8000', u'EA', u'01/30/2015', u'EA', u'1', u'1', u'1190.00', u'1', u'9520000.00', u'', u'0',
                          u'X43805', u'9116811031', u'10', u'1', u'20153976', u'ZSL', u'UGX', u'3436.82', u'9520000.00',
                          u'9520000.00', u'0.00', u'Techno Relief Services (U) Ltd', u'438', u'Uganda',
        ...
        work_book.save(self.purchase_order_with_missing_data_file_location)
    ...
    def test_should_not_load_purchase_order_with_missing_data(self):
