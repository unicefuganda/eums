...
class ConsigneeEndpointTest(APITestCase):
    ...
    def xtest_should_disallow_unicef_admin_to_delete_consignee_that_is_vision_imported(self):
    ...
    def xtest_should_disallow_unicef_editor_to_delete_consignee_that_is_vision_imported(self):
        consignee = ConsigneeFactory(name='New Consignee', imported_from_vision=True)
    ...
    def test_should_allow_ip_editor_to_delete_consignee_that_is_not_vision_imported(self):
        consignee = ConsigneeFactory(name='New Consignee', imported_from_vision=False)
    ...
    def xtest_should_disallow_ip_editor_to_delete_consignee_that_is_vision_imported(self):
        consignee = ConsigneeFactory(name='New Consignee', imported_from_vision=True)
