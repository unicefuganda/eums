...
from eums.test.api.api_test_helpers import create_item, create_sales_order, create_sales_order_item, \
    create_purchase_order, create_purchase_order_item
...
class POItemForSOItemEndPointTest(AuthenticatedAPITestCase):
    def test_should_get_po_item_for_so_item(self):
        ...
        purchase_order_item_details = {'purchase_order': created_purchase_order['id'], 'item_number': item['id'],
                                       'quantity': 12000, 'value': 100.0, 'item': item['id'],
        ...
        po_item_details = {u'id': created_purchase_order_item['id'], 'item_number': item['id'], 'item': item['id'],
                           'purchase_order': po_details, 'sales_order_item': created_sales_order_item['id'],
                           'quantity': Decimal('12000.00'), 'value': Decimal('100.00'), 'orderitem_ptr': 40}
