...
class ProductReceivedStatsTest(DeliveryStatsTestCase):
    ...
    def test_should_product_received_question_stats(self):
        ...
        self.assertEqual(response.data.get('percentageOfAwaitingResponseToProductReceived'), 0.0)
        ...
        self.assertEqual(response.data.get('percentageValueOfAwaitingResponseToProductReceived'), 0.0)
