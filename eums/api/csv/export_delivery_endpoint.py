...
from eums.services.csv_export_service import generate_delivery_export_csv, \
    generate_delivery_feedback_report_export_csv, \
...
class ExportDeliveryFeedbackReportViewSet(APIView):
    def get(self, request, *args, **kwargs):
        ...
        generate_delivery_feedback_report_export_csv.delay(user=request.user, host_name=host_name,
...
class ExportItemFeedbackReportViewSet(APIView):
    def get(self, request, *args, **kwargs):
        ...
        generate_item_feedback_report_export_csv.delay(user=request.user, host_name=host_name,
