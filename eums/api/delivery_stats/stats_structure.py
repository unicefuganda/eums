...
DeliveryStats = namedtuple('DeliveryStats', 'count_positive count_negative count_non_response count_awaiting_response '
                                            'percent_positive percent_negative percent_non_response '
                                            'percent_awaiting_response '
                                            ...
                                            'percent_value_awaiting_response')
